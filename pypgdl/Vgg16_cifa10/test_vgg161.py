...
pl.prepare_memory()
pl.init_variables()
pl.read_to_node_scalar('y', 'cifa10_y_trian', 1, n, y, 0)
pl.read_to_node_arr('x', 'cifa10_x_trian', 1, n, x, 0)
pl.compute_ex()
...
#
#         # if ii % 10 == 0:
#         pl.read_to_node_scalar('y', 'cifa10_y_trian', i, n, y, 0)
#         pl.read_to_node_arr('x', 'cifa10_x_trian', i, n, x, 0)
#         pl.compute_ex()
#         print("第"+str(ii)+"次：")
#         print(pl.get_loss())
